...
A10:D29の範囲（最大20行）に商品情報を入力してください：
...
**📝 明細行数の調整**: メニューの「📝 明細行数設定」から表示する明細行数（1-20行）を自由に変更できます。
...
- ✅ **柔軟な明細行数**: 最大20行まで対応、表示行数を1-20で自由に設定可能
- ✅ PDF生成（見積書・請求書）
